...
class LoreftIntervention(
    ...
    def __init__(self, **kwargs):
        ...
        self.low_rank_dimension = kwargs.get("low_rank_dimension", 16)
        rotate_layer = LowRankRotateLayer(self.embed_dim, self.low_rank_dimension)
        self.rotate_layer = torch.nn.utils.parametrizations.orthogonal(rotate_layer)
        self.learned_source = torch.nn.Linear(
            self.embed_dim, self.low_rank_dimension).to(
