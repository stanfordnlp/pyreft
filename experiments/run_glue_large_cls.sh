...
script1="experiments/run_glue_large_cls_cola.sh"
script2="experiments/run_glue_large_cls_mnli.sh"
script3="experiments/run_glue_large_cls_mrpc.sh"
script4="experiments/run_glue_large_cls_qnli.sh"
script5="experiments/run_glue_large_cls_qqp.sh"
script6="experiments/run_glue_large_cls_rte.sh"
script7="experiments/run_glue_large_cls_sst2.sh"
script8="experiments/run_glue_large_cls_stsb.sh"
