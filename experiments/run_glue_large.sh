...
script1="experiments/run_glue_large_cola.sh"
script2="experiments/run_glue_large_mnli.sh"
script3="experiments/run_glue_large_mrpc.sh"
script4="experiments/run_glue_large_qnli.sh"
script5="experiments/run_glue_large_qqp.sh"
script6="experiments/run_glue_large_rte.sh"
script7="experiments/run_glue_large_sst2.sh"
script8="experiments/run_glue_large_stsb.sh"
