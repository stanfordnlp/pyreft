...
# bash scripts/gqa_2.sh 2 snap/gqa/adapter4 9599 1 --gradient_accumulation_steps 8 --batchSize 32 --lr 1e-5 --warmup_ratio 0.05 --report_step 400 --use_separate_optimizer_for_visual --sgd_lr 0.001 --sgd_momentum 0.0 --epoch 5 --schedule 3 --use_positional_embedding --pos_num 25 --clip_model_name RN50x4 --loss_scale 500
